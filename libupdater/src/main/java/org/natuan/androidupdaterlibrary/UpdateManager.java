            ...
            if (context != null && updateInfo != null) {
                try {
                    ...
                    if (options.shouldCheckPackageName() && !packageName.equals(updateInfo.getPackageName())) {
                        ((AbstractUpdateListener) listener).onShowNoUpdateUI(updateInfo.isUserInitiativeClick());
                        return;
                    }
                    String PREFS_NAME = context.getResources().getString(R.string.preference_name);
                    String PREFS_KEY_SKIP_CHECK_UPDATE_VERSION_CODE = context.getResources().getString(
                            R.string.preference_key_skip_check_update_version_code);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_SHOW_NO_UPDATE_UI:
                    listener.onShowNoUpdateUI(false);
                    break;
