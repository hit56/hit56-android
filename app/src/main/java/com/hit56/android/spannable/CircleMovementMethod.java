package com.hit56.android.spannable;
...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = AppController.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = AppController.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
