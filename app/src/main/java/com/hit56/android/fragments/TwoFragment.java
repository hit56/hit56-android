...
public class TwoFragment extends Fragment implements SwipyRefreshLayout.OnRefreshListener{
...
//    private final String URL_PREIFX = "127.0.0.1:8083/getinfo/" + MainActivity.IMEI;
    ...
    private String getGpsUrl(String direction) {
        ...
        if(direction == "top"){
            return URL_PREIFX + "/car/" + MainActivity.latitude + "/" + MainActivity.longitude + "/" + max_offSet + "/" + direction;
        }
        return URL_PREIFX + "/car/" + MainActivity.latitude + "/" + MainActivity.longitude + "/" + min_offSet + "/" + direction;
    }
