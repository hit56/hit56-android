...
import com.hit56.android.spannable.CircleMovementMethod;
import com.hit56.android.spannable.SpannableClickable;
    ...
    private SpannableString setClickableSpan(final String textStr, final String id) {
        ...
        subjectSpanText.setSpan(new SpannableClickable(itemColor){
                                    ...
                                    public void onClick(View widget) {
                                        Toast.makeText(AppController.getContext(), textStr + " &id = " + id, Toast.LENGTH_SHORT).show();
                                    }
